          ...
          {[0, 1, 2, 3].map((index) => {
            ...
            return (
              <button
                ...
                disabled={disabled}
                className={`
                  size-8 rounded-full border bg-background flex items-center justify-center 
              ...
              >
                {isFilled && (
                  <span 
                    className="size-2 rounded-full bg-foreground transition-transform duration-150 animate-in zoom-in-50"
                  />
                )}
              </button>
            );
