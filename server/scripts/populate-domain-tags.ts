...
async function populateDomainTags() {
  try {
    ...
    const domainTagData = [
      ...
      {
        domain: 'github.com',
        tags: ['development', 'code', 'git', 'repository'],
        category: 'development',
        description: 'GitHub - Code repository hosting',
      },
      {
        domain: 'gitlab.com',
        tags: ['development', 'code', 'git', 'repository'],
      ...
      },
      {
        ...
        tags: ['development', 'code', 'git', 'repository'],
        category: 'development',
        description: 'Bitbucket - Git repository hosting',
      },
      {
        domain: 'stackoverflow.com',
        tags: ['programming', 'help', 'q&a', 'development'],
        category: 'development',
      ...
      },
      {
        ...
        tags: ['programming', 'help', 'q&a', 'development'],
        category: 'development',
        description: 'Stack Exchange - Q&A network',
      },
      {
        domain: 'dev.to',
        tags: ['development', 'blog', 'programming'],
        category: 'development',
        description: 'DEV Community - Developer blog platform',
      },
      {
        domain: 'hashnode.com',
        tags: ['development', 'blog', 'programming'],
        category: 'development',
        description: 'Hashnode - Developer blogging platform',
      },
      {
        domain: 'codepen.io',
        tags: ['development', 'demo', 'frontend'],
        category: 'development',
        description: 'CodePen - Frontend development playground',
      },
      {
        domain: 'jsfiddle.net',
        tags: ['development', 'demo', 'javascript'],
        category: 'development',
        description: 'JSFiddle - JavaScript playground',
      },
      {
        domain: 'codesandbox.io',
        tags: ['development', 'demo', 'react', 'vue'],
        category: 'development',
        description: 'CodeSandbox - Online IDE',
      },
      {
        domain: 'replit.com',
        tags: ['development', 'ide', 'programming'],
        category: 'development',
        description: 'Replit - Online coding environment',
      },
      {
        domain: 'glitch.com',
        tags: ['development', 'demo', 'web'],
        category: 'development',
        description: 'Glitch - Web app development platform',
      },

      // Package Managers & Libraries
      {
        domain: 'npmjs.com',
        tags: ['javascript', 'package', 'development'],
        category: 'development',
      ...
      },
      {
        ...
        tags: ['javascript', 'package', 'development'],
        category: 'development',
        description: 'Yarn - JavaScript package manager',
      },
      {
        domain: 'pypi.org',
        tags: ['python', 'package', 'development'],
        category: 'development',
        description: 'PyPI - Python package index',
      },
      {
        domain: 'crates.io',
        tags: ['rust', 'package', 'development'],
        category: 'development',
      ...
      },
      {
        ...
        category: 'development',
        description: 'Packagist - PHP package repository',
      },
      {
        domain: 'rubygems.org',
        tags: ['ruby', 'package', 'development'],
        category: 'development',
        description: 'RubyGems - Ruby package manager',
      },
      {
        domain: 'mvnrepository.com',
        tags: ['java', 'package', 'development'],
        category: 'development',
        description: 'Maven Repository - Java packages',
      },
      ...
      },
      {
        ...
        category: 'education',
        description: 'W3Schools - Web development tutorials',
      },
      {
        domain: 'developer.mozilla.org',
        tags: ['documentation', 'web', 'development'],
        category: 'documentation',
        description: 'MDN Developer Network',
      },
      {
        domain: 'docs.microsoft.com',
        tags: ['documentation', 'microsoft', 'development'],
        category: 'documentation',
        description: 'Microsoft Developer Documentation',
      },
      {
        domain: 'docs.aws.amazon.com',
        tags: ['documentation', 'aws', 'cloud'],
        category: 'documentation',
        description: 'AWS Documentation',
      },
      {
        domain: 'docs.azure.com',
        tags: ['documentation', 'azure', 'cloud'],
        category: 'documentation',
      ...
      {
        domain: 'youtube.com',
        tags: ['video', 'entertainment', 'media'],
        category: 'media',
      ...
      {
        domain: 'vimeo.com',
        tags: ['video', 'creative', 'media'],
        category: 'media',
        description: 'Vimeo - Video hosting platform',
      },
      {
        domain: 'twitch.tv',
        tags: ['video', 'gaming', 'streaming'],
        category: 'media',
        description: 'Twitch - Live streaming platform',
      },
      {
        domain: 'netflix.com',
      ...
      // Social & Community
      {
        ...
        category: 'social',
        description: 'Reddit - Social news aggregation',
      },
      {
        domain: 'twitter.com',
        tags: ['social', 'microblog'],
        category: 'social',
        description: 'Twitter - Microblogging platform',
      },
      {
        domain: 'x.com',
        tags: ['social', 'microblog'],
      ...
      },
      {
        ...
        category: 'social',
        description: 'Facebook - Social networking',
      },
      {
        domain: 'instagram.com',
        tags: ['social', 'photo', 'visual'],
        category: 'social',
        description: 'Instagram - Photo sharing',
      },
      {
        domain: 'tiktok.com',
        tags: ['social', 'video', 'short-form'],
        category: 'social',
      ...
      // Design & Creative
      {
        ...
        category: 'design',
        description: 'Dribbble - Design portfolio platform',
      },
      {
        domain: 'behance.net',
      ...
      {
        domain: 'figma.com',
        tags: ['design', 'ui', 'tool', 'collaboration'],
        category: 'design',
      ...
      },
      {
        ...
        tags: ['design', 'ui', 'tool'],
        category: 'design',
        description: 'Sketch - Digital design tool',
      },
      {
        domain: 'adobe.com',
        tags: ['design', 'creative', 'software'],
        category: 'design',
        description: 'Adobe - Creative software suite',
      },
      {
        domain: 'canva.com',
        tags: ['design', 'graphics', 'tool'],
        category: 'design',
        description: 'Canva - Graphic design platform',
      },
      {
        domain: 'unsplash.com',
        tags: ['photos', 'stock', 'images'],
        category: 'design',
        description: 'Unsplash - Free stock photos',
      },
      {
        domain: 'pexels.com',
        tags: ['photos', 'stock', 'images'],
      ...
      },
      {
        ...
        category: 'design',
        description: 'Google Fonts - Web fonts',
      },
      ...
      },
      {
        ...
        tags: ['productivity', 'project-management', 'tool'],
        category: 'productivity',
        description: 'Asana - Work management',
      },
      {
        domain: 'slack.com',
        tags: ['productivity', 'communication', 'tool'],
        category: 'productivity',
      ...
      {
        domain: 'zoom.us',
        tags: ['communication', 'video', 'meeting'],
        category: 'productivity',
      ...
      },
      {
        ...
        tags: ['document', 'collaboration', 'productivity'],
        category: 'productivity',
        description: 'Google Docs - Online document editor',
      },
      {
        domain: 'sheets.google.com',
        tags: ['spreadsheet', 'data', 'productivity'],
        category: 'productivity',
        description: 'Google Sheets - Online spreadsheet',
      },
      {
        domain: 'slides.google.com',
        tags: ['presentation', 'slides', 'productivity'],
        category: 'productivity',
        description: 'Google Slides - Online presentation',
      },
      {
        domain: 'drive.google.com',
        tags: ['storage', 'file-sharing', 'productivity'],
        category: 'productivity',
      ...
      },
      {
        ...
        category: 'productivity',
        description: 'Google Calendar - Online calendar',
      },
      ...
      },
      {
        ...
        category: 'cloud',
        description: 'Google Cloud Platform - Cloud services',
      },
      {
      ...
      },
      {
        ...
        tags: ['cloud', 'hosting', 'frontend'],
        category: 'cloud',
        description: 'Netlify - Web development platform',
      },
      ...
      },
      {
        ...
        tags: ['ecommerce', 'wordpress', 'business'],
        category: 'business',
      ...
      {
        domain: 'squareup.com',
        tags: ['payment', 'pos', 'business'],
        category: 'business',
        description: 'Square - Payment and POS system',
      },
      ...
      // Content Management
      {
        ...
        category: 'cms',
        description: 'WordPress.com - Blog and website platform',
      },
      {
        domain: 'wordpress.org',
        tags: ['cms', 'open-source', 'website'],
        category: 'cms',
        description: 'WordPress.org - Open source CMS',
      },
      {
        domain: 'wix.com',
        tags: ['website', 'builder', 'tool'],
        category: 'cms',
      ...
      },
      {
        ...
        category: 'cms',
        description: 'Webflow - Visual web design platform',
      },
      ...
      },
      {
        ...
        tags: ['education', 'course', 'learning'],
        category: 'education',
        description: 'Udemy - Online learning platform',
      },
      {
        domain: 'edx.org',
        tags: ['education', 'course', 'learning'],
        category: 'education',
        description: 'edX - Online courses',
      },
      {
        domain: 'khanacademy.org',
        tags: ['education', 'learning', 'free'],
        category: 'education',
        description: 'Khan Academy - Free online learning',
      },
      {
        domain: 'freecodecamp.org',
        tags: ['education', 'programming', 'free'],
        category: 'education',
        description: 'freeCodeCamp - Free programming education',
      },
      {
        domain: 'codecademy.com',
        tags: ['education', 'programming', 'interactive'],
        category: 'education',
        description: 'Codecademy - Interactive programming courses',
      },
      {
        domain: 'pluralsight.com',
        tags: ['education', 'technology', 'learning'],
        category: 'education',
        description: 'Pluralsight - Technology learning platform',
      },
      {
        domain: 'udacity.com',
        tags: ['education', 'programming', 'nanodegree'],
        category: 'education',
        description: 'Udacity - Technology education',
      },
      ...
      // News & Media
      {
        ...
        category: 'news',
        description: 'Hacker News - Tech news and discussion',
      },
      {
      ...
      },
      {
        ...
        category: 'news',
        description: 'The Verge - Technology and culture',
      },
      {
        domain: 'wired.com',
        tags: ['tech', 'news', 'culture'],
        category: 'news',
        description: 'Wired - Technology and culture magazine',
      },
      {
        domain: 'medium.com',
      ...
      {
        domain: 'substack.com',
        tags: ['newsletter', 'writing', 'subscription'],
        category: 'media',
      ...
      // Reference & Knowledge
      {
        ...
        category: 'reference',
        description: 'Wikipedia - Free encyclopedia',
      },
      {
      ...
      },
      {
        ...
        tags: ['reference', 'dictionary', 'language'],
        category: 'reference',
        description: 'Dictionary.com - Online dictionary',
      },
      {
      ...
      {
        domain: 'twilio.com',
        tags: ['communication', 'api', 'sms'],
        category: 'api',
        description: 'Twilio - Communication platform API',
      },
      {
        domain: 'sendgrid.com',
        tags: ['email', 'api', 'communication'],
        category: 'api',
